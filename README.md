...
> **Nota:** Para experimentar la experiencia del Admin, importa el json de Admin de la carpeta "importData" en tu Mongo DB. Si deseas tambien puedes importar los demás json para una experiencia más rápida.
> 
## Descripción General
